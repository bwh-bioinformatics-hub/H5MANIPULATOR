...
#' Read .h5 Cell SampleInfo
#'
#' @param h5_file the path to an .h5 file in 10x Genomics format
#' @param target A matrix object in the .h5 file with a /sample object and/or a /target/observations/ sub-group. Default is "matrix".
#'
#' @return A data.frame containing all sample metadata found in /target/sample and /target/observations/
#' @export
#'


read_h5ad_sample_meta <- function(h5ad_file) {
  ...
  var_locs <- h5ad_contents$full_name[h5ad_contents$group == "/sample"]
